...
$navClass = ['nav', 'astroid-nav', 'navbar-dark', 'bg-primary', 'navbar','justify-content-center', 'd-flex', 'align-items-center'];
      ...
      <div class="header-stacked-section d-flex justify-content-between flex-column w-100">
         ...
         if ($mode == 'center') {
            ...
            if ($block_1_type == 'position') {
               echo '<div class="w-100 header-block-item d-none d-flex justify-content-center py-1 mr-5 text-right"><div class="row">';
