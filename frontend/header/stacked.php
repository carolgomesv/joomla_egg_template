...
$navClass = ['nav', 'astroid-nav', 'navbar-dark', 'bg-primary', 'navbar', 'justify-content-center', 'd-flex', 'align-items-center', 'text-uppercase'];
      ...
      <div class="header-stacked-section d-flex justify-content-between flex-column w-100">
         ...
         if ($mode == 'center') {
            ...
            if ($block_1_type == 'position') {
               echo '<div id="header-modules" class="w-100 header-block-item d-none d-flex justify-content-center py-1 mr-5"><div class="row">';
               echo $template->renderModulePosition($block_1_position, 'xhtml');
               echo '</div></div>';
            }
            if ($block_1_type == 'custom') {
               echo '<div id="header-modules" class="w-100 header-block-item d-none d-flex justify-content-center py-1 mr-5">
               <div class="row">';
               echo $block_1_custom;
               echo '</div></div>';
            }
            ...
            echo '</div>';
            // header nav starts -->
            echo '<div class="w-100 d-none d-lg-flex justify-content-center pt-2">';
